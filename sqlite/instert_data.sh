...
insert into commute_time values ( 1855,'"Campus Region B"', '"Region A"', 2000, 10, 19, '"F"', '"Italian"', '"CS"', '"Bachelor 1st year"', '"Bus"');
insert into commute_time values ( 1856,'"Campus Region C"', '"Region A"', 2000, 10, 21, '"M"', '"Greek"', '"History"', '"Bachelor 3rd  year', '"Bus"');
insert into commute_time values ( 1857,'"Campus Region A"', '"Region B"', 2000, 10, 22, '"F"', '"German"', '"Arts"', '"Master', '"Bus"');
...
insert into commute_time values ( 1862,'"Campus Region A"', '"Region A"', 1000, 5, 24, '"F"', '"German"', '"Arts"', '"Master"', '"Foot"');
insert into commute_time values ( 1863,'"Campus Region C"', '"Region A"', 1100, 5, 18, '"M"', '"Italian"', '"History"', '"Bachelor 1st year"', '"Foot"');
insert into commute_time values ( 1864,'"Campus Region A"', '"Region C"', 1100, 5, 23, '"F"', '"Russian"', '"Arts"', '"Bachelor 3rd year"', '"Foot"');
...
insert into commute_time values ( 1867,'"Campus Region B"', '"Region C"', 2000, 10, 23, '"F"', '"Greek"', '"CS"', '"Bachelor 2nd year"', '"Bus"');
insert into commute_time values ( 1868,'"Campus Region A"', '"Region A"', 1000, 5, 19, '"F"', '"Turkish"', '"Arts"', '"Bachelor 1st year"', '"Foot"');
...
insert into commute_time values ( 1872,'"Campus Region A"', '"Region A"', 1000, 5, 21, '"F"', '"German"', '"Arts"', '"Bachelor 2nd"', '"Foot"');
insert into commute_time values ( 1873,'"Campus Region C"', '"Region B"', 2000, 10, 19, '"F"', '"UK"', '"History"', '"Bachelor 1st year"', '"Bus"');
EOF